    ...
    <div className="min-h-screen bg-gray-900 flex flex-col">
      ...
      <div className="bg-gray-800 p-2 text-center">
        ...
        {connectionState === 'disconnected' && (
          <div className="text-red-400">Partner disconnected. Looking for someone new...</div>
        )}
        {error && (
      ...
      <div className="flex-1 relative">
        ...
        {localStream && (
          <div className="absolute bottom-4 right-4 w-48 h-36 rounded-lg overflow-hidden bg-gray-900 border-2 border-white shadow-lg">
            <VideoPlayer 
              stream={localStream} 
              isLocal 
              className="w-full h-full object-cover"
